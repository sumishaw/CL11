    ...
    override fun configureFlutterEngine(flutterEngine: FlutterEngine) {
        ...
        methodChannel?.setMethodCallHandler { call, result ->
            when (call.method) {
                ...
                // DIAGNOSTIC ONLY — manual, one-time test of what Live
                // Caption's own "Hide" button actually does on this device.
                // NOT automatic. See the risk explanation in
                // LiveCaptionReader.testLiveCaptionHideButton() — this could
                // minimize LC to a pill (good) or fully turn it off (bad,
                // breaks this app's data source). Must be observed manually
                // before ever being made a real feature.
                "testLiveCaptionHideButton" -> {
                    val outcome = LiveCaptionReader.instance?.testLiveCaptionHideButton()
                        ?: "FAILED: LiveCaptionReader accessibility service is not currently running"
